...
GSASysCon comes with a fully automated setup script. The installation instructions can be found in the file system_control/docs/SetupGuide.txt. Follow the instructions in the Setup Guide and run a "first test" to confirm success.
